...
from pyjs import create_once_callable


setTimeout = pyjs.js.setTimeout
...
async def queueing_job(i=1):
    pyjs.internal.console_log(f"await sleep {i}")
    await asyncio.sleep(i)
    pyjs.internal.console_log(f"await sleep {i} done")


future = asyncio.ensure_future(queueing_job(1))
